            ...
            <div class="col-12">
                <nav
                    ...
                    <div class="container-fluid">
                        <a class="flash navbar-brand font-weight-bolder ms-sm-3"
                        ...
                        <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0" id="navigation">
                            <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="flash nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                                        id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                                        Blog
                                        <img src="~/assets/img/down_arrow.svg" alt="down-arrow" class="arrow ms-1">
                                    </a>
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg"
                                        ...
                                        <div class="d-none d-lg-block">
                                            <li class="nav-item ">
                                                <a class="flash dropdown-item py-2 ps-3 border-radius-md"
                                                    href="javascript:;">
                                                    <div class="d-flex">
                                ...
                                <li class="nav-item ms-lg-auto my-auto ms-3 ms-lg-0">
                                    <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro"
                                        class="btn btn-sm  bg-gradient-warning  btn-round mb-0 me-1 mt-2 mt-md-0">Contact
                                        us</a>
                                </li>
                            </ul>
                        </div>
